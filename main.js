...
function submit() {
    ...
    for (var alumno = 1; alumno <= 4; alumno++){
        var nombre_alumno = document.getElementById("Nombre_Pasatiempo_" + alumno).value;
        console.log(nombre_alumno);
        nombre_alumno_array.push(nombre_alumno);
    };
    console.log (nombre_alumno_array);
    var nombre_alumno_array_longitud = nombre_alumno_array.length;
    console.log (nombre_alumno_array_longitud);
    for (var longitud = 1; longitud <= nombre_alumno_array_longitud; longitud++){
        ver_alumno_array.push("<h4>NOMBRE - "+ nombre_alumno_array[longitud] + "</h4>");
